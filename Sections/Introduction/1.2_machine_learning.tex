...
{
define test set, training set and validation set. Relate to error and empirical risk of classifier.A Probabilistic Theory of Pattern Recognition 4.5 virker relevant. Link to the pareto principle.
