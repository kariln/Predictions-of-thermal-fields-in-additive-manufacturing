...
"""THERMAL MODEL"""
scripted_part = FEA_MODEL('experiment_15.py')
...
#JOB
scripted_part.create_job(thermal, 'experiment15_thermal')
scripted_part.submit_job('experiment15_thermal')

""" MECHANICICAL MODEL"""

""" ODB """
process_odb = Odb('experiment15_thermal',scripted_part, part1)
