# -*- coding: utf-8 -*-
"""
Created on Sat Apr 10 13:53:12 2021
...
"""THERMAL MODEL"""
scripted_part = FEA_MODEL('experiment_13.py')
...
#JOB
scripted_part.create_job(thermal, 'experiment13_thermal')
scripted_part.submit_job('experiment13_thermal')
