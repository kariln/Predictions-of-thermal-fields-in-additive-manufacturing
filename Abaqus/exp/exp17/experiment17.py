# -*- coding: utf-8 -*-
"""
Created on Wed Apr 28 09:11:55 2021
...
"""THERMAL MODEL"""
scripted_part = FEA_MODEL('experiment_16.py')
...
#JOB
scripted_part.create_job(thermal, 'experiment16_thermal')
scripted_part.submit_job('experiment16_thermal')

""" MECHANICICAL MODEL"""

""" ODB """
process_odb = Odb('experiment16_thermal',scripted_part, part1)
