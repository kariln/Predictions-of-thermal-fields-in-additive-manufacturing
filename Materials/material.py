# -*- coding: utf-8 -*-
"""
Created on Thu Oct  8 16:08:30 2020

@author: kariln

creating a material class to create material objects with material properties
"""
import os
...
def main():        
    materials = {}
    AA2319 = Material(['conductivity','density','elasticity','expansion','latent_heat','plasticity','specific_heat'],'AA2319')
    materials["AA2319"] = AA2319
